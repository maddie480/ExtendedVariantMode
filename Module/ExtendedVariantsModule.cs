...
namespace ExtendedVariants.Module {
    public class ExtendedVariantsModule : EverestModule {
        ...
        public enum Variant {
            ...
            WaterSurfaceSpeedX, WaterSurfaceSpeedY, LiftboostCapX, LiftboostCapUp, LiftboostCapDown, AutoJump, AutoDash, DashRefillCooldown,
        ...
        public ExtendedVariantsModule() {
            ...
            VariantHandlers[Variant.DashRefillCooldown] = new DashRefillCooldown();
