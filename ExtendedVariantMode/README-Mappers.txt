...
- New Value: pick the value you want to set the variant to. Those are the internal values used by the mod:
	- Gravity, FallSpeed, JumpHeight, SpeedX, DashSpeed, Friction, HyperdashSpeed, DashLength: the value is the multiplier * 10 (for example, "12" will set the option to 1.2x).
	...
	- DisableWallJumping, UpsideDown, ForceDuckOnGround: 1 to enable, 0 to disable.
