...
- New Value: pick the value you want to set the variant to. Those are the internal values used by the mod:
	...
	- DisableWallJumping, UpsideDown, ForceDuckOnGround, InvertDashes, DisableNeutralJumping, BadelineChasersEverywhere, AffectExistingChasers, RefillJumpsOnDashRefill: 1 to enable, 0 to disable.
